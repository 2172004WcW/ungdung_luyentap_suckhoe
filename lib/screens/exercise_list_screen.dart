...
class _ExerciseListScreenState extends State<ExerciseListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.grey[50], // Nền hơi xám nhẹ để Card nổi bật hơn
      appBar: AppBar(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Hero(
                            tag: exercise.name, // Hiệu ứng chuyển cảnh mượt mà
                            child: ClipRRect(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: const TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold,
                                    color: primaryColor, // Đổi từ tím sang xanh
                                  ),
                                ),
