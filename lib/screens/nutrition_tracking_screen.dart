...
class _NutritionTrackingScreenState extends State<NutritionTrackingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<DailyNutrition?>(
        future: _loadDailyNutrition(),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildStatCard(
                          'Calo',
                          '${nutrition.totalCalories.toStringAsFixed(0)} / ${nutrition.targetCalories ?? 0}',
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('${nutrition.waterIntake}ml / 2000ml'),
                          IconButton(
                            icon: const Icon(Icons.add_circle),
                            onPressed: () => _addWater(nutrition),
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _buildMealsList(DailyNutrition nutrition) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final meals = nutrition.meals.where((m) => m.type == type).toList();
        ...
        return Card(
          ...
          child: ExpansionTile(
            ...
            subtitle: Text('${meals.length} món'),
            ...
            children: meals.map((meal) {
              return ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () => _deleteMeal(meal, nutrition),
                ),
              );
            }).toList(),
          ),
  ...
  Future<DailyNutrition?> _loadDailyNutrition() async {
  ...
  Future<void> _addWater(DailyNutrition nutrition) async {
    ...
    if (confirmed == true) {
      ...
      final updated = DailyNutrition(
        ...
        waterIntake: nutrition.waterIntake + ml,
      );
  ...
  Future<void> _deleteMeal(Meal meal, DailyNutrition nutrition) async {
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (context) => AlertDialog(
    ...
    if (confirmed == true) {
      final updated = DailyNutrition(
        date: nutrition.date,
        meals: nutrition.meals.where((m) => m.id != meal.id).toList(),
        targetCalories: nutrition.targetCalories,
        targetProtein: nutrition.targetProtein,
        targetCarbs: nutrition.targetCarbs,
        targetFat: nutrition.targetFat,
